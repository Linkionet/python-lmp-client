...
DEVICE_CLASS_BINARY_OUTPUT = 0 # binary-output
DEVICE_CLASS_LEVEL_OUTPUT = 1 # level-output
DEVICE_CLASS_ONOFF_LIGHT = 16 # onoff-light
DEVICE_CLASS_DIMMABLE_LIGHT = 17 # dimmable-light
DEVICE_CLASS_COLOR_DIMMABLE_LIGHT = 18 # color-dimmable-light
DEVICE_CLASS_COLOR_WHITE_DIMMABLE_LIGHT = 19 # color-white-dimmable-light
DEVICE_CLASS_TUNABLE_WHITE_LIGHT = 20 # tunable-white-light
DEVICE_CLASS_STRING = 32 # string
DEVICE_CLASS_AUDIO_OUTPUT = 48 # audio-output
DEVICE_CLASS_VIDEO_OUTPUT = 64 # video-output
DEVICE_CLASS_BINARY_SENSOR = 128 # binary-sensor
DEVICE_CLASS_ANALOG_SENSOR = 129 # analog-sensor
DEVICE_CLASS_CONTROLLER = 160 # controller
DEVICE_CLASS_AUDIO_INPUT = 176 # audio-input
DEVICE_CLASS_VIDEO_INPUT = 192 # video-input
DEVICE_CLASS_GATEWAY = 254 # gateway
